    ...
    it("Test view edit", function () {
        ...
        return new Promise(function (resolve, reject) {
            setTimeout(function () {
                ...
                button.click();
                expect($("#ViewMessage").attr("style").includes("display: block")).toEqual(true);
                $("#ViewMessage-comment").click();
                setTimeout(function () {
                    expect($("#ViewComment").attr("style").includes("display: block")).toEqual(true);
                    resolve();
                }, 100);
            }, 100);
        });
    ...
    it("Test view post", function () {
        ...
        return new Promise(function (resolve, reject) {
            setTimeout(function () {
                ...
                button.click();
                expect($("#EditEntryForm").attr("style").includes("display: block")).toEqual(true);
                $("#EditEntryForm-Close").click();
                setTimeout(function () {
                    expect($("#EditEntryForm").attr("style").includes("display: none")).toEqual(true);
                    resolve();
                }, 100);
            }, 100);
        });
...
describe("Tests", function () {
    it("Test Login Profile", function () {
        ...
        return new Promise(function (resolve, reject) {
            setTimeout(function () {
                expect($("#SignIn").attr("style").includes("display: block")).toEqual(true);
                $("#SignIn-Close").click();
                setTimeout(function () {
                    expect($("#SignIn").attr("style").includes("display: none")).toEqual(true);
                    resolve();
                }, 100);
            }, 100);
        });
...
describe("Tests", function () {
    it("Test Search Title", function () {
        ...
        return new Promise(function (resolve, reject) {
            setTimeout(function () {
                expect($("#Navbar").attr("style").includes("display: block")).toEqual(false);
            }, 100);
        });
    });
});
