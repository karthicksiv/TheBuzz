...
public class EditCommentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.content_edit_comment);
        ...
        final String URL = String.format(Routes.getCommentUrl(), id) + "/edit";
            ...
            public void onClick(View view) {
                ...
                if (!em.getText().toString().equals("")) {
                    ...
                    try {
                        ...
                        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.PUT, URL, ob,
                                new Response.Listener<JSONObject>() {
                                    @Override
                                    public void onResponse(JSONObject response) {
                                        Log.d("bmw", "post success");
                                        Toast.makeText(EditCommentActivity.this, "Comment Successful", Toast.LENGTH_LONG).show();
